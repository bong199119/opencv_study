...
# 모델 & 설정 파일
model = r'D:\project\opencv_study\code\openpose\pose_iter_440000.caffemodel'
config = r'D:\project\opencv_study\code\openpose/pose_deploy_linevec.prototxt'
...
# 테스트 이미지 파일
path_for_image = r'D:\project\opencv_study\Lecture_materials\ch13'
...
print('ok')
for f in img_files:
    path_f = os.path.join(path_for_image, f)
    img = cv2.imread(path_f)
