...
path_img = r'C:\Users\Administrator\Desktop\opencv\data\apple.jpg'
path_grass = r'C:\Users\Administrator\Desktop\opencv\data\grass.jpg'

src = cv2.imread(path_img, cv2.IMREAD_COLOR)
# cv2.IMREAD_UNCHANGED : 이미지파일을 alpha channel까지 포함하여 읽어 들입니다.
# src = cv2.imread(path_img, cv2.IMREAD_UNCHANGED)
mask = cv2.imread(path_img, cv2.IMREAD_GRAYSCALE)
